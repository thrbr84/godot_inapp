...
class_name IAP, "res://iap-lib/icon.png"
...
signal sku_details_complete(result)
signal sku_details_error(error_message)
...
func sku_details_complete(result):
	...
	emit_signal("sku_details_complete", result)


func sku_details_error(error_message):
	#print("error_sku_details = ", error_message)
	emit_signal("sku_details_error", error_message)
